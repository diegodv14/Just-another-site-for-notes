    ...
    return (
        <>
            <div className="flex auth flex-col gap-7 justify-center relative items-center w-screen h-screen text-white">
                <div className="top-[5%] lg:left-[42%] absolute flex flex-row gap-6 pl-6 p-3 pr-6 bg-black lg:bg-transparent text-white rounded-full">
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="flex mt-14 text-black lg:flex-col gap-3 lg:gap-6 p-4 rounded-lg justify-center transform: rotate-[3deg]">
                    <h1 style={{ userSelect: "none" }} className="self-center text-xl absolute -top-8 lg:static lg:text-3xl flex gap-4 justify-center items-center whitespace-nowrap">Just another site for notes <span className="animate-bounce"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" className="bi bi-pencil" viewBox="0 0 16 16">
