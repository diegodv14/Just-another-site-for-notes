...
export const ToolBar = ({ setSearch, search }) => {
    ...
    return (
        <><section className="w-full h-[100px] border-b p-6 flex gap-6 items-center justify-between">
            ...
            <div className="relative p-2">
                <label htmlFor="search" className="absolute bottom-5 left-4"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-search" viewBox="0 0 16 16">
