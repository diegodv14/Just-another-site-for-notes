export const FinanceIcon = () => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" className="bi bi-cash" viewBox="0 0 16 16">
...
export const StudyIcon = () => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" className="bi bi-journal-album" viewBox="0 0 16 16">
...
export const TravelIcon = () => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" className="bi bi-luggage" viewBox="0 0 16 16">
...
export const HealthIcon = () => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" className="bi bi-bandaid-fill" viewBox="0 0 16 16">
