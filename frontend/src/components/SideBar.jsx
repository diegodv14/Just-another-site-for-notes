...
export const SideBar = () => {
    ...
    return (
        <>
            <nav className="w-[250px] h-full text-white bg-zinc-900 shadow-lg p-6 flex flex-col justify-between items-center">
                Welcome
                <button onClick={() => logout()} className="scale-100 active:scale-90">
